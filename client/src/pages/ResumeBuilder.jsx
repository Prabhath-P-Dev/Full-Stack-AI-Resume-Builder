...
import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, Icon, Share2Icon, Sparkles, User } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 pb-8" >
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
              ...
              <button onClick={()=> {toast.promise(saveResume, {loading:"saving..."})}} className="bg-gradient-t0-br from-green-100 to-green-200 ring-green-300 text-grren-600 ring hover:ring-green-400 transition-all rounded-md px-6 py-2 mt-6 text-sm">Save Changes</button>
              </div>
            </div>
            {/* Right Panel - Preview */}
               ...
               <div className="relative w-full">
                  <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                    {resumeData.public && (
                        ...
                        <button onClick={handleShare} className="flex items-centerp-2 px-4 gap-2 text-xs bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 rounded-lg ring-blue-300 hover:ring transition-colors">
