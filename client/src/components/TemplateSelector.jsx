...
const TemplateSelector = ({selectedTemplate, onchange}) =>{
    ...
    const templates = [
        ...
        },
        {
            id:"minimal-image",
            name:"Minimal Image",
            preview:"Minimal design with a single image and a clean typography"
        },
        {
            id:"minimal",
            name:"Minimal",
    ...
    <div className="relative">
      <button onClick={()=>setIsOpen(!isOpen)} className="flex items-center gap-1 twxt-sm text-blue-600 bg-gradient-to-br from-blue-50 to-blue-100 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-lg">
