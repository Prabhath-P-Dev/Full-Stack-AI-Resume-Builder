import { Briefcase, BriefcaseBusiness, Globe, Mail, MapPin, Phone, PhoneCall, User, } from "lucide-react";
...
const PersonalInfoForm = ({data, onChange, removeBackground, setRemoveBackground }) => {
    ...
    const fields =[
        ...
        {key:"phone", label:"Phone Number", icon:PhoneCall, type:"tel"},
        {key:"location", label:"Location", icon:MapPin, type:"text"},
        {key:"profession", label:"Profession", icon:BriefcaseBusiness, type:"text"},
        {key:"linkedin", label:"LinkedIn Profile", icon:Briefcase, type:"url"},
